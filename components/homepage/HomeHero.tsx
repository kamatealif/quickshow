                  ...
                  {activeIdx === index && (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        <button className="px-10 py-5 bg-white/5 backdrop-blur-md text-foreground border border-white/10 rounded-[1.5rem] font-black uppercase italic tracking-tighter text-sm flex items-center gap-3 hover:bg-white/10 transition-all active:scale-95">
